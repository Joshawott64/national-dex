import pokemonList from "./api_JSONs/pokeapi_all_pokemon.json" with { type: "json" };
import pokemonSpeciesList from "./api_JSONs/pokeapi_all_pokemon_species.json" with { type: "json" };
import typesList from "./api_JSONs/pokeapi_all_types.json" with { type: "json" };
import movesList from "./api_JSONs/pokeapi_all_moves.json" with { type: "json" };
import abilitiesList from "./api_JSONs/pokeapi_all_abilities.json" with { type: "json" };
import generationsList from "./api_JSONs/pokeapi_all_generations.json" with { type: "json" };
import versionsList from "./api_JSONs/pokeapi_all_versions.json" with { type: "json" };
import chainList from "./api_JSONs/pokeapi_all_evolution_chains.json" with { type: "json" };
